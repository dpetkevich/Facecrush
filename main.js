...
function submitPost(){
   ...
   $new_post = $('.comment_box').first().clone();
   $new_post.find(".comment_blurb").html( $("#new_post_title").val() );
   $new_post.find(".content").html( $("#new_post_body").val() );
   $new_post.find(".time").html( "just now.");
